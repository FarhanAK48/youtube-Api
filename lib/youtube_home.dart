...
import 'package:youtubedata/Utils/services.dart';
import 'package:youtubedata/modal/ChannelInfo.dart';
import 'package:youtubedata/modal/video_list.dart';
import 'package:youtubedata/modal_video_player.dart';
import 'package:youtubedata/player_page.dart';
              ...
              InkWell(
                child: Container(
                  ...
                  child: Row(
                    children: [
                      CachedNetworkImage(
                          imageUrl: ListData[0]['items'][i]['snippet']
                      ...
                      Flexible(
                          child: Text(ListData[0]['items'][i]['snippet']
                                  ['title']
                              .toString())),
                    ],
                  ),
                ...
                onTap: () {
                  final videoId = ListData[0]['items'][i]['snippet']
                      ['resourceId']['videoId'];
                  final videoTitle =
                      ListData[0]['items'][i]['snippet']['title'];
